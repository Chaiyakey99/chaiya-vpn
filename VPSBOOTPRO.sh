...
# ══════════════════════════════════════════
echo ""
echo "== [1/12] ตั้งค่า sysctl (BBR + FQ + MTU Probing + buffer + keepalive) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [2/12] ตั้ง qdisc ของ $IFACE เป็น fq =="
...
# ══════════════════════════════════════════
echo ""
echo "== [3/12] เปิด RPS/RFS บนทุก RX queue ของ $IFACE =="
...
# ══════════════════════════════════════════
echo ""
echo "== [4/12] เพิ่ม ring buffer / txqueuelen ของ $IFACE =="
...
# ══════════════════════════════════════════
echo ""
echo "== [5/12] ตั้ง initcwnd/initrwnd = 20 บน default route =="
...
# ══════════════════════════════════════════
echo ""
echo "== [6/12] ตั้ง CPU governor เป็น performance =="
...
# ══════════════════════════════════════════
echo ""
echo "== [7/12] เพิ่ม file descriptor limit (ulimit) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [8/12] ตรวจสอบ Path MTU (diagnostic) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [10/12] เปิด multiqueue บน $IFACE (combined=$NCPU) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [11/12] ตรวจสอบ/เปิด GRO/GSO/TSO บน $IFACE =="
if command -v ethtool &>/dev/null; then
...
# ══════════════════════════════════════════
echo ""
echo "== [12/12] ตั้ง net.core.netdev_budget / netdev_budget_usecs =="
