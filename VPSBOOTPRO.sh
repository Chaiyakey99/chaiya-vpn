...
# ══════════════════════════════════════════
echo ""
echo "== [1/14] ตั้งค่า sysctl (BBR + FQ + MTU Probing + buffer + keepalive) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [2/14] ตั้ง qdisc ของ $IFACE เป็น fq =="
...
# ══════════════════════════════════════════
echo ""
echo "== [3/14] เปิด RPS/RFS บนทุก RX queue ของ $IFACE =="
...
# ══════════════════════════════════════════
echo ""
echo "== [4/14] เพิ่ม ring buffer / txqueuelen ของ $IFACE =="
...
# ══════════════════════════════════════════
echo ""
echo "== [5/14] ตั้ง initcwnd/initrwnd = 20 บน default route =="
...
# ══════════════════════════════════════════
echo ""
echo "== [6/14] ตั้ง CPU governor เป็น performance =="
...
# ══════════════════════════════════════════
echo ""
echo "== [7/14] เพิ่ม file descriptor limit (ulimit) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [8/14] ตรวจสอบ Path MTU (diagnostic) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [10/14] เปิด multiqueue บน $IFACE (combined=$NCPU) =="
...
# ══════════════════════════════════════════
echo ""
echo "== [11/14] ตรวจสอบ/เปิด GRO/GSO/TSO บน $IFACE =="
if command -v ethtool &>/dev/null; then
...
# ══════════════════════════════════════════
echo ""
echo "== [12/14] ตั้ง net.core.netdev_budget / netdev_budget_usecs =="
...
# ══════════════════════════════════════════
echo ""
echo "== [14/14] ตั้ง interrupt coalescing ต่ำสุด (adaptive off, rx/tx-usecs=0) =="
if command -v ethtool &>/dev/null; then
